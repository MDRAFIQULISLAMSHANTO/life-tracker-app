      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            placeholder="000000"
            maxLength={6}
            className="w-full px-4 py-3 border border-token rounded-xl surface-2 text-strong focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-center text-2xl tracking-widest font-medium"
            required
            disabled={loading}
          />
